        ...
        execute: function() {
            AboutComponent = (function () {
                ...
                AboutComponent.prototype.getData = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + '/form/aboutForm')
                        .subscribe(function (res) {
                        _this.data = res.json()['data'];
                    });
                };
...
System.register("form/person", [], function(exports_14, context_14) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_14("Person", Person);
        }
    }
});
System.register("form/person-form.component", ['@angular/core', "form/person"], function(exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    var core_5, person_1;
    var PersonFormComponent;
    return {
        setters:[
            function (core_5_1) {
                core_5 = core_5_1;
        ...
        execute: function() {
            ...
            exports_15("PersonFormComponent", PersonFormComponent);
        }
    }
});
System.register("form/index", ["form/person-form.component"], function(exports_16, context_16) {
    "use strict";
    ...
    return {
        setters:[
            function (person_form_component_1_1) {
                exportStar_5(person_form_component_1_1);
            }],
        execute: function() {
        }
    }
});
System.register("app.component", ['@angular/core', '@angular/router', "app.html", "home/index", "products/index", "about/index", "contact/index", "form/index"], function(exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    var core_6, router_1, app_html_1, home_1, products_1, about_1, contact_1, form_1;
    var AppComponent;
    return {
        setters:[
            function (core_6_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.Routes([
                        ...
                        { path: '/form', component: form_1.PersonFormComponent }
                    ]), 
                    __metadata('design:paramtypes', [])
                ], AppComponent);
                return AppComponent;
...
System.register("main", ['@angular/platform-browser-dynamic', '@angular/router', '@angular/http', "app.component"], function(exports_18, context_18) {
    "use strict";
